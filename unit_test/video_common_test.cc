...
TEST_F(LibYUVBaseTest, TestFourCC) {
  ...
  ASSERT_TRUE(TestValidFourCC(FOURCC_NV16, FOURCC_BPP_NV16));
  ASSERT_TRUE(TestValidFourCC(FOURCC_NV24, FOURCC_BPP_NV24));
  ...
  ASSERT_TRUE(TestValidFourCC(FOURCC_P410, FOURCC_BPP_P410));
